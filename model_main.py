...
flags.DEFINE_string(
    'model_dir', 'training_output', 'Path to output model directory '
    'where event and checkpoint files will be written.')
flags.DEFINE_string('pipeline_config_path', 'training/config/ppn_pipeline.config', 'Path to pipeline config '
                    'file.')
...
def main(unused_argv):
  ...
  if FLAGS.checkpoint_dir:
    ...
    eval_specs = [tf.estimator.EvalSpec(
        eval_input_fn,
        steps=1,
        name='validation',
        start_delay_secs=5,
